/**
* build.js - compile sog-helper engine from source into single javascript library
* This uses the Closure Compiler which requires java to be installed
* Example usage:
*
* // regular release build
* node build.js -l 0 -o output/sog-helper.js
* // production minified build
* node build.js -l 1 -o output/sog-helper.min.js
* // include extra debug code
* node build.js -l 0 -d -o output/sog-helper.dbg.js
*/
...
var DEFAULT_OUTPUT = "output/sog-helper.js";
...
var getCopyrightNotice = function (ver, rev) {
    ...
    return [
        "/*",
        " * SOG Helper Library v" + ver + " revision " + rev + buildOptions,
...
var arguments = function () {
    ...
    process.argv.forEach(function (arg) {
        if (arg === '-h') {
            console.log("Build Script for SOG Helper Library\n");
            ...
            console.log("-o PATH: output file path [output/sog-helper.js]");
